...
class Node():
    ...
    def __repr__(self):
        return (
        f'Node data: {self.data}, Node children: {self.children}')
    ...
    def print_children(self):
        for child in self.children:
            print(f'Node {child.data} is child of Node {self.data}')
    ...
    def print_descendants(self):
        ...
        while nodes_to_check:  # [] == false
            ...
            # print value
            print(f'Node {curr.data} is descendant of Node {self.data}')
    ...
    def is_descendant(self, node):
        nodes_to_check = node.children.copy()
...
# node1.print_children()
# node2.print_descendants()
node3.is_ancestor(9)  # True
node8.is_descendant(node3)